...
""", "Output = ", sorting.linearSearch(data: [6, 5, 26, 5, 31, 50, 23, 10, 55, 67, 90, 2, 10, 7, 4, 9, 100, 36, 99, 20], item: 10),
"""
...
""", "Output = ", sorting.binarySearch(data: [-150, -40, 0, 5, 12, 34, 56, 105, 263], item: 56)
)
